...
router.post("/create",upload.single("productImg") ,inventoryController.createInventory);
router.get("/get", inventoryController.getAllInventory);
router.get("/get/:id", inventoryController.getSingleInventory);
router.put("/edit/:id",upload.single("productImg"), inventoryController.editInventory);
